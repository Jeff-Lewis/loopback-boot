...
module.exports = function compile(options) {
  ...
  var mixinDirs = options.mixinDirs || modelsMeta.mixins || ['./mixins'];
  var mixinInstructions =
    buildAllMixinInstructions(appRootDir, mixinDirs, options);
...
function buildAllMixinInstructions(appRootDir, mixinDirs, options) {
  ...
  files.forEach(function(filepath) {
    ...
    var name = normalizeMixinName(path.basename(filepath, ext));
...
function normalizeMixinName(str) { // classify names: foo-bar => FooBar
